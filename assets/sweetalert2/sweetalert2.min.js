!(function (t, e) {
        ...
        r >= o.progressSteps.length && W("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
            o.progressSteps.forEach(function (t, e) {
                ...
                i.appendChild(t),
                    ...
                    e !== o.progressSteps.length - 1 && ((t = o), (e = document.createElement("li")), vt(e, $["progress-step-line"]), t.progressStepsDistance && (e.style.width = t.progressStepsDistance), i.appendChild(e));
            });
    }
    function Nt(t, e) {
        var n,
    ...
    function pe() {
        ...
        Tt.innerParams.get(this) &&
            ...
            at(t.loader),
            (e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"))).length ? rt(e[0], "inline-block") : wt(T()) || wt(L()) || wt(D()) || at(t.actions),
    ...
    var Ve = ["swal-title", "swal-html", "swal-footer"],
        ...
        Qe = function (t, e, n) {
            ...
            ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) || ("MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints)) &&
                ...
                ((o = document.body.scrollTop), (document.body.style.top = "".concat(-1 * o, "px")), vt(document.body, $.iosfix), ve(), ge()),
